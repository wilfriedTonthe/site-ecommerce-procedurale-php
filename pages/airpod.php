...
<body>
   ...
   <source src="airpods.mp4" type="video/mp4">
    ...
    <section class="product-cards-section">
        <div class="card">
            <img src="airpod1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="airpod2.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="airpod3.jpg" class="card-img-top" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="airpod4.jpg" class="card-img-top" alt="...">
            <div class="card-body">
