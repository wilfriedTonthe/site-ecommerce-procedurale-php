...
if ($_SESSION['utilisateur']['role'] !== 'SuperAdmin') {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add_promotion'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            $prix_initial = $row['prix_unitaire'];
        } else {
        ...
        $sql = "REPLACE INTO promotion (id_produit, pourcentage, datedefin, prix_initial) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("iisd", $id_produit, $pourcentage, $datedefin, $prix_initial);
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div id="products" style="display: <?php echo (isset($_GET['section']) && $_GET['section'] == 'products') ? 'block' : 'none'; ?>;">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a class="btn btn-success me-2" href="formulaire.php"><i class="bi bi-plus-circle"></i> Ajouter iphnoe</a>
                   
                        <a class="btn btn-success me-2" href="formulairemac.php"><i class="bi bi-plus-circle"></i> Ajouter Mac</a>
                  
                        <a class="btn btn-success me-2" href="fomulaireipade.php"><i class="bi bi-plus-circle"></i> Ajouter ipad</a>
                    </div>
                    <div class="card">
